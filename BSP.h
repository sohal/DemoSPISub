...
#define BSP_PILOT_FLASH_SIZE_BYTES	(0x00007FFFUL)
...
#define BSP_TORQUE_FLASH_END				(BSP_ALLBOARD_FLASH_START + BSP_PILOT_FLASH_SIZE_BYTES)
...
#define BSP_NUCLEO_UART_BAUD				1125000U
